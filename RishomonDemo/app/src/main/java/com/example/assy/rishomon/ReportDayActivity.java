...
public class ReportDayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ApiReadData()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GlobalConstants.JSON_URL_READ_REPORTS_DAY,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ReportDayActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                        hidePDialog();
                    }
                }){
            @Override
            protected Map<String,String> getParams(){
                ...
                params.put(GlobalConstants.KEY_DATE,formattedDate);
                return params;
            }
